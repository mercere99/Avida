# This is the Avida base Makefile that sets up variables for all of the others to include.
# To use, you must first setup EMP_DIR to indicate the offset of the Empirical root directory.
...
FLAGS_include = -Isource/ -I$(EMP_DIR)/include/ -I$(CATCH_DIR)
